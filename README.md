...
8.	Establece el cronograma con una expresión CRON que represente tu necesidad (por ejemplo, 0 0 0 * * * para ejecutar a medianoche todos los días).
   
10.	Selecciona "Create New Blueprint File" cuando se te pregunte dónde colocar la función.  
